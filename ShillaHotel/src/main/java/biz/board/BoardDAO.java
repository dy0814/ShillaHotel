...
public class BoardDAO {
	...
	// 전체 게시글 갯수 가져오는 메서드
		...
		// 새글 쓰기
		   ...
		   //글 검색
		   public ArrayList<BoardVO> SearchBoard(String searchCol, String searchText) {
			    ...
			    try {
			        // 기본 SQL 쿼리
			    	// 검색어 칸이 비어있는 경우엔 모든 게시물 출력
			        String sql = "select * from shilla_board";

			        // 검색어가 있는 경우
			        if(searchText != null && !searchText.equals("")) {
			            // "all"인 경우 subject와 content에서 검색
