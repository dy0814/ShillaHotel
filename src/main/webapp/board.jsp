						...
						<ul class="pagination">
							...
							<c:choose>
								<c:when test="${startPage > 1}">
									<li class="prev_page_btn"><a
										href="${currentPageName}?pageNum=${startPage-10}&searchCol=${searchCol}&searchText=${searchText}"
										aria-label="Previous" class="page-link"><span></span></a></li>
								</c:when>
								<c:otherwise>
									<li class="prev_page_btn"><a href="#"
										aria-label="Previous" class="page-link"
										onclick="event.preventDefault();"><span></span></a></li>
								</c:otherwise>
							</c:choose>
							...
							<c:choose>
								<c:when test="${endPage < pageCount}">
									<li class="next_page_btn"><a
										href="${currentPageName}?pageNum=${startPage+10}&searchCol=${searchCol}&searchText=${searchText}"
										aria-label="Next" class="page-link"><span></span></a></li>
								</c:when>
								<c:otherwise>
									<li class="next_page_btn"><a href="#" aria-label="Next"
										class="page-link" onclick="event.preventDefault();"><span></span></a>
									</li>
								</c:otherwise>
							</c:choose>
